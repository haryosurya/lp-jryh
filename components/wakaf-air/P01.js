...
export default class P01 extends Component{
    ...
    return(
        <section className="banner-one" id="banner" style={{backgroundImage:'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"> <path fill="#ffeff0" fill-opacity="1" d="M0,64L30,58.7C60,53,120,43,180,80C240,117,300,203,360,245.3C420,288,480,288,540,293.3C600,299,660,309,720,298.7C780,288,840,256,900,224C960,192,1020,160,1080,149.3C1140,139,1200,149,1260,170.7C1320,192,1380,224,1410,240L1440,256L1440,320L1410,320C1380,320,1320,320,1260,320C1200,320,1140,320,1080,320C1020,320,960,320,900,320C840,320,780,320,720,320C660,320,600,320,540,320C480,320,420,320,360,320C300,320,240,320,180,320C120,320,60,320,30,320L0,320Z"></path> </svg>'}}>
