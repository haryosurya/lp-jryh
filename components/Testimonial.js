...
const Testimonial = () => {
    ...
    return (
        ...
        <section className="testimonials__one" id="testimonials">
            <img src="/images/shapes/map-1-1.png" alt="Awesome Image" className="map-img"/>
            <img src="/images/shapes/testi-shape-1.png" alt="" className="testimonials__one-shape-1"/>
                <img src="/images/shapes/testi-shape-2.png" alt="" className="testimonials__one-shape-2"/>
